...
export const itemsOnFirstLevel=()=>{
    let array=[
      new glockItems(348,621,true),new dynamiteItems(348,621,true), new helperSpawnRuna(348,621,true), new AxeItems(348,621,true), new AxeItems(348,621,true),new AxeItems(348,621,true),new AxeItems(348,621,true),new AxeItems(348,621,true),new AxeItems(348,621,true),new AxeItems(348,621,true),new AxeItems(348,621,true),
